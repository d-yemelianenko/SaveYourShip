...
public class Generator : MonoBehaviour
{
    ...
    private void IceCubeGenerator()   //Wype³nienie planszy bloczkami lodu i lodowymi górami
    {
        ...
        GameObject fishesParentObject = new GameObject("Fishes");

        int i = 0, j = 0; // j - tworzy przerwy w generowaniu gór lodowych,
        for (var z = 0; z < mapLength; z += 4)
        {
            for (var x = 0; x < mapWidth; x += 4)
            {
                ...
                int randomSpawnFish = rnd.Next(1, 100);
                ...
                if (randomSpawnFish <= spawnFishRate)
                {
